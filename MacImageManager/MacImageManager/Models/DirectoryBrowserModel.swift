...
class DirectoryBrowserModel: ObservableObject {
...
extension DirectoryBrowserModel {
    static func forPreview() -> DirectoryBrowserModel {
        ...
        // This is a simple mock, you would want to also create a mock isDirectory.
        // For a full solution, you would create a mock file manager.
        return model
    }
}
